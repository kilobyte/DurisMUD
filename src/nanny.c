...
static void LoadNewbyShit(P_char ch, int *items)
{
	...
	for (i = 0; items[i] != -1; i++)
	{
		...
		{
			obj->cost = 1;
			if (obj->type != ITEM_FOOD && obj->type != ITEM_WEAPON && obj->type != ITEM_SPELLBOOK && obj->type != ITEM_LIGHT && obj->type != ITEM_TOTEM && IS_PC(ch))
...
void load_obj_to_newbies(P_char ch)
{
	...
	/*Thrikreen Basics*/
	static int thrikreen_good_eq[] = {677, 283, 285, 1112, 286, 288, 290, 613, 398, 398, 1176, 1167, -1};

	static int thrikreen_evil_eq[] = {677, 283, 285, 1112, 286, 288, 290, 613, 1170, 1173, -1};

	/*Minotaur Basics*/
	static int minotaur_good_eq[] = {677, 283, 285, 1112, 286, 288, 290, 398, 398, 1176, 1167, 1182, 603, 108, 109, 111, -1};

	static int minotaur_evil_eq[] = {677, 283, 285, 1112, 286, 288, 290, 1170, 1173, 1182, 603, 108, 109, 111, -1};
...
#define PROTECT(...) __VA_ARGS__
	CREATE_KIT(RACE_BARBARIAN, 0, PROTECT({677, 283, 285, 1112, 286, 288, 290, 560, 603, 398, 398, 1154, 1155, -1}));
	CREATE_KIT(RACE_BARBARIAN, CLASS_WARRIOR, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1109, -1}));

	CREATE_KIT(RACE_BARBARIAN, CLASS_RANGER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1108, -1}));

	CREATE_KIT(RACE_BARBARIAN, CLASS_PALADIN, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1110, -1}));

	CREATE_KIT(RACE_BARBARIAN, CLASS_ANTIPALADIN, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1110, -1}));

	CREATE_KIT(RACE_BARBARIAN, CLASS_CLERIC, PROTECT({1119, 1120, 1121, 1122, 1124, 1126, 1127, -1}));

	CREATE_KIT(RACE_BARBARIAN, CLASS_DRUID, PROTECT({1135, 1136, 1137, 1138, 1139, 1140, -1}));

	CREATE_KIT(RACE_BARBARIAN, CLASS_SHAMAN, PROTECT({108, 109, 111, 1144, 1145, 1146, 1127, -1}));

	CREATE_KIT(RACE_BARBARIAN, CLASS_SORCERER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_BARBARIAN, CLASS_NECROMANCER, PROTECT({1112, 1114, 1115, 1141, 1142, 1143, 203, 204, -1}));

	CREATE_KIT(RACE_BARBARIAN, CLASS_CONJURER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_BARBARIAN, CLASS_SUMMONER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_BARBARIAN, CLASS_MONK, PROTECT({1147, 1148, 1149, 1150, 1151, -1}));

	CREATE_KIT(RACE_BARBARIAN, CLASS_MERCENARY, PROTECT({1101, 1102, 1103, 1104, 1106, 1107, 1108, 1112, -1}));

	CREATE_KIT(RACE_BARBARIAN, CLASS_ROGUE, PROTECT({1112, 1112, 1128, 1129, 1130, 1131, 1132, 412, 412, 412, 412, 412, -1}));

	CREATE_KIT(RACE_BARBARIAN, CLASS_BARD, PROTECT({1112, 1128, 1129, 1130, 1131, 1134, 1241, 203, 204, -1}));

	CREATE_KIT(RACE_BARBARIAN, CLASS_ALCHEMIST, PROTECT({377, 676, 52, -1}));

	CREATE_KIT(RACE_BARBARIAN, CLASS_ILLUSIONIST, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_BARBARIAN, CLASS_ETHERMANCER, PROTECT({706, 735, 731, 731, -1}));

	CREATE_KIT(RACE_BARBARIAN, CLASS_REAVER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1108, 203, 204, -1}));

	/*Githzerai Basics*/
	CREATE_KIT(RACE_GITHZERAI, 0, PROTECT({677, 283, 285, 1112, 286, 288, 290, 566, 390, 398, 398, 1152, 1153, -1}));

	/*Githzerai Classes*/
	CREATE_KIT(RACE_GITHZERAI, CLASS_WARRIOR, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1109, -1}));

	CREATE_KIT(RACE_GITHZERAI, CLASS_RANGER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1108, -1}));

	CREATE_KIT(RACE_GITHZERAI, CLASS_PALADIN, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1110, -1}));

	CREATE_KIT(RACE_GITHZERAI, CLASS_ANTIPALADIN, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1110, -1}));

	CREATE_KIT(RACE_GITHZERAI, CLASS_CLERIC, PROTECT({1119, 1120, 1121, 1122, 1124, 1126, 1127, -1}));

	CREATE_KIT(RACE_GITHZERAI, CLASS_DRUID, PROTECT({1135, 1136, 1137, 1138, 1139, 1140, -1}));

	CREATE_KIT(RACE_GITHZERAI, CLASS_SHAMAN, PROTECT({108, 109, 111, 1144, 1145, 1146, 1127, -1}));

	CREATE_KIT(RACE_GITHZERAI, CLASS_SORCERER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_GITHZERAI, CLASS_NECROMANCER, PROTECT({1112, 1114, 1115, 1141, 1142, 1143, 203, 204, -1}));

	CREATE_KIT(RACE_GITHZERAI, CLASS_CONJURER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_GITHZERAI, CLASS_SUMMONER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_GITHZERAI, CLASS_MONK, PROTECT({1147, 1148, 1149, 1150, 1151, -1}));

	CREATE_KIT(RACE_GITHZERAI, CLASS_MERCENARY, PROTECT({1101, 1102, 1103, 1104, 1106, 1107, 1108, 1112, -1}));

	CREATE_KIT(RACE_GITHZERAI, CLASS_ROGUE, PROTECT({1112, 1112, 1128, 1129, 1130, 1131, 1132, 412, 412, 412, 412, 412, -1}));

	CREATE_KIT(RACE_GITHZERAI, CLASS_BARD, PROTECT({1112, 1128, 1129, 1130, 1131, 1134, 1241, 203, 204, -1}));

	CREATE_KIT(RACE_GITHZERAI, CLASS_ALCHEMIST, PROTECT({377, 676, 52, -1}));

	CREATE_KIT(RACE_GITHZERAI, CLASS_ILLUSIONIST, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_GITHZERAI, CLASS_ETHERMANCER, PROTECT({706, 735, 731, 731, -1}));

	CREATE_KIT(RACE_GITHZERAI, CLASS_REAVER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1108, 203, 204, -1}));

	/* Tiefling Basics */

	CREATE_KIT(RACE_TIEFLING, 0, PROTECT({677, 283, 285, 1112, 286, 288, 290, 566, 390, 398, 398, 1152, 1153, -1}));

	/* Tiefling Classes */
	CREATE_KIT(RACE_TIEFLING, CLASS_WARRIOR, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1109, -1}));

	CREATE_KIT(RACE_TIEFLING, CLASS_RANGER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1108, -1}));

	CREATE_KIT(RACE_TIEFLING, CLASS_PALADIN, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1110, -1}));

	CREATE_KIT(RACE_TIEFLING, CLASS_ANTIPALADIN, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1110, -1}));

	CREATE_KIT(RACE_TIEFLING, CLASS_CLERIC, PROTECT({1119, 1120, 1121, 1122, 1124, 1126, 1127, -1}));

	CREATE_KIT(RACE_TIEFLING, CLASS_DRUID, PROTECT({1135, 1136, 1137, 1138, 1139, 1140, -1}));

	CREATE_KIT(RACE_TIEFLING, CLASS_SHAMAN, PROTECT({108, 109, 111, 1144, 1145, 1146, 1127, -1}));

	CREATE_KIT(RACE_TIEFLING, CLASS_SORCERER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_TIEFLING, CLASS_NECROMANCER, PROTECT({1112, 1114, 1115, 1141, 1142, 1143, 203, 204, -1}));

	CREATE_KIT(RACE_TIEFLING, CLASS_CONJURER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_TIEFLING, CLASS_SUMMONER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_TIEFLING, CLASS_MONK, PROTECT({1147, 1148, 1149, 1150, 1151, -1}));

	CREATE_KIT(RACE_TIEFLING, CLASS_MERCENARY, PROTECT({1101, 1102, 1103, 1104, 1106, 1107, 1108, 1112, -1}));

	CREATE_KIT(RACE_TIEFLING, CLASS_ROGUE, PROTECT({1112, 1112, 1128, 1129, 1130, 1131, 1132, 412, 412, 412, 412, 412, -1}));

	CREATE_KIT(RACE_TIEFLING, CLASS_BARD, PROTECT({1112, 1128, 1129, 1130, 1131, 1134, 1241, 203, 204, -1}));

	CREATE_KIT(RACE_TIEFLING, CLASS_ALCHEMIST, PROTECT({377, 676, 52, -1}));

	CREATE_KIT(RACE_TIEFLING, CLASS_ILLUSIONIST, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_TIEFLING, CLASS_ETHERMANCER, PROTECT({706, 735, 731, 731, -1}));

	CREATE_KIT(RACE_TIEFLING, CLASS_REAVER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1108, 203, 204, -1}));
	/* End Tiefling */

	/*Human Basics*/
	CREATE_KIT(RACE_HUMAN, 0, PROTECT({677, 283, 285, 1112, 286, 288, 290, 566, 390, 398, 398, 1152, 1153, -1}));

	/*Human Classes*/
	CREATE_KIT(RACE_HUMAN, CLASS_WARRIOR, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1109, -1}));

	CREATE_KIT(RACE_HUMAN, CLASS_RANGER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1108, -1}));

	CREATE_KIT(RACE_HUMAN, CLASS_PALADIN, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1110, -1}));

	CREATE_KIT(RACE_HUMAN, CLASS_ANTIPALADIN, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1110, -1}));

	CREATE_KIT(RACE_HUMAN, CLASS_CLERIC, PROTECT({1119, 1120, 1121, 1122, 1124, 1126, 1127, -1}));

	CREATE_KIT(RACE_HUMAN, CLASS_DRUID, PROTECT({1135, 1136, 1137, 1138, 1139, 1140, -1}));

	CREATE_KIT(RACE_HUMAN, CLASS_SHAMAN, PROTECT({108, 109, 111, 1144, 1145, 1146, 1127, -1}));

	CREATE_KIT(RACE_HUMAN, CLASS_SORCERER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_HUMAN, CLASS_NECROMANCER, PROTECT({1112, 1114, 1115, 1141, 1142, 1143, 203, 204, -1}));

	CREATE_KIT(RACE_HUMAN, CLASS_CONJURER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_HUMAN, CLASS_SUMMONER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_HUMAN, CLASS_MONK, PROTECT({1147, 1148, 1149, 1150, 1151, -1}));

	CREATE_KIT(RACE_HUMAN, CLASS_MERCENARY, PROTECT({1101, 1102, 1103, 1104, 1106, 1107, 1108, 1112, -1}));

	CREATE_KIT(RACE_HUMAN, CLASS_ROGUE, PROTECT({1112, 1112, 1128, 1129, 1130, 1131, 1132, 412, 412, 412, 412, 412, -1}));

	CREATE_KIT(RACE_HUMAN, CLASS_BARD, PROTECT({1112, 1128, 1129, 1130, 1131, 1134, 1241, 203, 204, -1}));

	CREATE_KIT(RACE_HUMAN, CLASS_ALCHEMIST, PROTECT({377, 676, 52, -1}));

	CREATE_KIT(RACE_HUMAN, CLASS_ILLUSIONIST, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_HUMAN, CLASS_ETHERMANCER, PROTECT({706, 735, 731, 731, -1}));

	CREATE_KIT(RACE_HUMAN, CLASS_REAVER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1108, 203, 204, -1})); /*END Human Classes*/

	/*Drow Elf Basics*/
	CREATE_KIT(RACE_DROW, 0, PROTECT({677, 283, 285, 1112, 286, 288, 290, 561, 604, 36016, 1156, 1157, -1}));

	/*Drow Elf Classes*/
	CREATE_KIT(RACE_DROW, CLASS_WARRIOR, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1109, -1}));

	CREATE_KIT(RACE_DROW, CLASS_RANGER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1108, -1}));

	CREATE_KIT(RACE_DROW, CLASS_PALADIN, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1110, -1}));

	CREATE_KIT(RACE_DROW, CLASS_ANTIPALADIN, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1110, -1}));

	CREATE_KIT(RACE_DROW, CLASS_CLERIC, PROTECT({1119, 1120, 1121, 1122, 1124, 1126, 1127, -1}));
	...
	CREATE_KIT(RACE_DROW, CLASS_SORCERER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_DROW, CLASS_NECROMANCER, PROTECT({1112, 1114, 1115, 1141, 1142, 1143, 203, 204, -1}));

	CREATE_KIT(RACE_DROW, CLASS_CONJURER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_DROW, CLASS_SUMMONER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_DROW, CLASS_MONK, PROTECT({1147, 1148, 1149, 1150, 1151, -1}));

	CREATE_KIT(RACE_DROW, CLASS_MERCENARY, PROTECT({1101, 1102, 1103, 1104, 1106, 1107, 1108, 1112, -1}));

	CREATE_KIT(RACE_DROW, CLASS_ROGUE, PROTECT({1112, 1112, 1128, 1129, 1130, 1131, 1132, 412, 412, 412, 412, 412, -1}));

	CREATE_KIT(RACE_DROW, CLASS_BARD, PROTECT({1112, 1128, 1129, 1130, 1131, 1134, 1241, 203, 204, -1}));

	CREATE_KIT(RACE_DROW, CLASS_ALCHEMIST, PROTECT({377, 676, 52, -1}));

	CREATE_KIT(RACE_DROW, CLASS_ILLUSIONIST, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_DROW, CLASS_ETHERMANCER, PROTECT({706, 735, 731, 731, -1}));

	CREATE_KIT(RACE_DROW, CLASS_REAVER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1108, 203, 204, -1}));

	/*END Drow Elf Classes*/

	/*Duergar Basics*/
	CREATE_KIT(RACE_DUERGAR, 0, PROTECT({677, 283, 285, 1112, 286, 288, 290, 562, 605, 1164, 1165, -1}));

	/*Duergar Classes*/
	CREATE_KIT(RACE_DUERGAR, CLASS_WARRIOR, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1109, -1}));

	CREATE_KIT(RACE_DUERGAR, CLASS_RANGER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1108, -1}));

	CREATE_KIT(RACE_DUERGAR, CLASS_PALADIN, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1110, -1}));

	CREATE_KIT(RACE_DUERGAR, CLASS_ANTIPALADIN, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1110, -1}));

	CREATE_KIT(RACE_DUERGAR, CLASS_CLERIC, PROTECT({1119, 1120, 1121, 1122, 1124, 1126, 1127, -1}));

	CREATE_KIT(RACE_DUERGAR, CLASS_DRUID, PROTECT({1135, 1136, 1137, 1138, 1139, 1140, -1}));

	CREATE_KIT(RACE_DUERGAR, CLASS_SHAMAN, PROTECT({108, 109, 111, 1144, 1145, 1146, 1127, -1}));

	CREATE_KIT(RACE_DUERGAR, CLASS_SORCERER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_DUERGAR, CLASS_NECROMANCER, PROTECT({1112, 1114, 1115, 1141, 1142, 1143, 203, 204, -1}));

	CREATE_KIT(RACE_DUERGAR, CLASS_CONJURER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_DUERGAR, CLASS_SUMMONER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_DUERGAR, CLASS_MONK, PROTECT({1147, 1148, 1149, 1150, 1151, -1}));

	CREATE_KIT(RACE_DUERGAR, CLASS_MERCENARY, PROTECT({1101, 1102, 1103, 1104, 1106, 1107, 1108, 1112, -1}));

	CREATE_KIT(RACE_DUERGAR, CLASS_ROGUE, PROTECT({1112, 1112, 1128, 1129, 1130, 1131, 1132, 412, 412, 412, 412, 412, -1}));

	CREATE_KIT(RACE_DUERGAR, CLASS_BARD, PROTECT({1112, 1128, 1129, 1130, 1131, 1134, 1241, 203, 204, -1}));

	CREATE_KIT(RACE_DUERGAR, CLASS_ALCHEMIST, PROTECT({377, 676, 52, -1}));

	CREATE_KIT(RACE_DUERGAR, CLASS_ILLUSIONIST, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_DUERGAR, CLASS_ETHERMANCER, PROTECT({706, 735, 731, 731, -1}));

	CREATE_KIT(RACE_DUERGAR, CLASS_REAVER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1108, 203, 204, -1}));
	/*END Duergar Classes*/

	/*Gnome Basics*/
	CREATE_KIT(RACE_GNOME, 0, PROTECT({677, 283, 285, 1112, 286, 288, 290, 563, 605, 398, 398, 1166, 1167, -1}));

	/*Gnome Classes*/
	CREATE_KIT(RACE_GNOME, CLASS_WARRIOR, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1109, -1}));

	CREATE_KIT(RACE_GNOME, CLASS_RANGER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1108, -1}));

	CREATE_KIT(RACE_GNOME, CLASS_PALADIN, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1110, -1}));

	CREATE_KIT(RACE_GNOME, CLASS_ANTIPALADIN, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1110, -1}));

	CREATE_KIT(RACE_GNOME, CLASS_CLERIC, PROTECT({1119, 1120, 1121, 1122, 1124, 1126, 1127, -1}));

	CREATE_KIT(RACE_GNOME, CLASS_DRUID, PROTECT({1135, 1136, 1137, 1138, 1139, 1140, -1}));

	CREATE_KIT(RACE_GNOME, CLASS_SHAMAN, PROTECT({108, 109, 111, 1144, 1145, 1146, 1127, -1}));

	CREATE_KIT(RACE_GNOME, CLASS_SORCERER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_GNOME, CLASS_NECROMANCER, PROTECT({1112, 1114, 1115, 1141, 1142, 1143, 203, 204, -1}));

	CREATE_KIT(RACE_GNOME, CLASS_CONJURER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_GNOME, CLASS_SUMMONER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_GNOME, CLASS_MONK, PROTECT({1147, 1148, 1149, 1150, 1151, -1}));

	CREATE_KIT(RACE_GNOME, CLASS_MERCENARY, PROTECT({1101, 1102, 1103, 1104, 1106, 1107, 1108, 1112, -1}));

	CREATE_KIT(RACE_GNOME, CLASS_ROGUE, PROTECT({1112, 1112, 1128, 1129, 1130, 1131, 1132, 412, 412, 412, 412, 412, -1}));

	CREATE_KIT(RACE_GNOME, CLASS_BARD, PROTECT({1112, 1128, 1129, 1130, 1131, 1134, 1241, 203, 204, -1}));

	CREATE_KIT(RACE_GNOME, CLASS_ALCHEMIST, PROTECT({377, 676, 52, -1}));

	CREATE_KIT(RACE_GNOME, CLASS_ILLUSIONIST, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_GNOME, CLASS_ETHERMANCER, PROTECT({706, 735, 731, 731, -1}));

	CREATE_KIT(RACE_GNOME, CLASS_REAVER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1108, 203, 204, -1}));
	/*END Gnome Classes*/

	/*Half Elf Basics*/
	CREATE_KIT(RACE_HALFELF, 0, PROTECT({677, 283, 285, 1112, 286, 288, 290, 564, 607, 398, 398, 1160, 1161, -1}));

	/*Half Elf Class EQ*/
	CREATE_KIT(RACE_HALFELF, CLASS_WARRIOR, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1109, -1}));

	CREATE_KIT(RACE_HALFELF, CLASS_CONJURER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, -1}));

	CREATE_KIT(RACE_HALFELF, CLASS_SUMMONER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, -1}));

	CREATE_KIT(RACE_HALFELF, CLASS_SORCERER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, -1}));

	CREATE_KIT(RACE_HALFELF, CLASS_NECROMANCER, PROTECT({1114, 1115, 1143, 706, 735, 731, 731, -1}));

	CREATE_KIT(
		RACE_HALFELF, CLASS_RANGER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1113, 1113, 1114, 1115, 1116, 1117, 1117, 1117, 1117, 1117, 1117, 1117, 1117, 1117, 1117, 1118, -1}));
	...
	CREATE_KIT(RACE_HALFELF, CLASS_ASSASSIN, PROTECT({1112, 1112, 1128, 1129, 1130, 1131, -1}));

	CREATE_KIT(RACE_HALFELF, CLASS_THIEF, PROTECT({1112, 1128, 1129, 1130, 1131, 1132, 412, 412, 412, 412, 412, -1}));

	CREATE_KIT(RACE_HALFELF, CLASS_ROGUE, PROTECT({1112, 1128, 1129, 1130, 1131, 1132, 412, 412, 412, 412, 412, -1}));

	CREATE_KIT(RACE_HALFELF, CLASS_PALADIN, PROTECT({1101, 1102, 1103, 1107, 1110, -1}));

	CREATE_KIT(RACE_HALFELF, CLASS_THEURGIST, PROTECT({1112, 1114, 1115, 1141, 1142, 1143, -1}));
	/*END Half Elf Classes*/

	/*Halfling Basics*/
	CREATE_KIT(RACE_HALFLING, 0, PROTECT({677, 283, 285, 1112, 286, 288, 290, 565, 608, 398, 398, 1168, 1169, -1}));

	/*Halfling Classes*/
	CREATE_KIT(RACE_HALFLING, CLASS_WARRIOR, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1109, -1}));

	CREATE_KIT(RACE_HALFLING, CLASS_RANGER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1108, -1}));

	CREATE_KIT(RACE_HALFLING, CLASS_PALADIN, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1110, -1}));

	CREATE_KIT(RACE_HALFLING, CLASS_ANTIPALADIN, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1110, -1}));

	CREATE_KIT(RACE_HALFLING, CLASS_CLERIC, PROTECT({1119, 1120, 1121, 1122, 1124, 1126, 1127, -1}));

	CREATE_KIT(RACE_HALFLING, CLASS_DRUID, PROTECT({1135, 1136, 1137, 1138, 1139, 1140, -1}));

	CREATE_KIT(RACE_HALFLING, CLASS_SHAMAN, PROTECT({108, 109, 111, 1144, 1145, 1146, 1127, -1}));

	CREATE_KIT(RACE_HALFLING, CLASS_SORCERER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_HALFLING, CLASS_NECROMANCER, PROTECT({1112, 1114, 1115, 1141, 1142, 1143, 203, 204, -1}));

	CREATE_KIT(RACE_HALFLING, CLASS_CONJURER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_HALFLING, CLASS_SUMMONER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_HALFLING, CLASS_MONK, PROTECT({1147, 1148, 1149, 1150, 1151, -1}));

	CREATE_KIT(RACE_HALFLING, CLASS_MERCENARY, PROTECT({1101, 1102, 1103, 1104, 1106, 1107, 1108, 1112, -1}));

	CREATE_KIT(RACE_HALFLING, CLASS_ROGUE, PROTECT({1112, 1112, 1128, 1129, 1130, 1131, 1132, 412, 412, 412, 412, 412, -1}));

	CREATE_KIT(RACE_HALFLING, CLASS_BARD, PROTECT({1112, 1128, 1129, 1130, 1131, 1134, 1241, 203, 204, -1}));

	CREATE_KIT(RACE_HALFLING, CLASS_ALCHEMIST, PROTECT({377, 676, 52, -1}));

	CREATE_KIT(RACE_HALFLING, CLASS_ILLUSIONIST, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_HALFLING, CLASS_ETHERMANCER, PROTECT({706, 735, 731, 731, -1}));

	CREATE_KIT(RACE_HALFLING, CLASS_REAVER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1108, 203, 204, -1}));

	/*END Halfling Classes*/

	/*Thrikreen Classes*/
	CREATE_KIT(RACE_THRIKREEN, CLASS_WARRIOR, PROTECT({1101, 1101, 1102, 1104, 1104, 1105, 1105, 1105, 1105, 1106, 580, 580, 580, 580, 581, 581, -1}));
	/*END Thrikreen Classes*/

	/*Centaur Basics*/
	CREATE_KIT(RACE_CENTAUR, 0, PROTECT({677, 283, 285, 1112, 286, 288, 290, 398, 398, 591, 590, 1178, 1179, -1}));

	/*Centaur Classes*/
	CREATE_KIT(RACE_CENTAUR, CLASS_WARRIOR, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1109, -1}));

	CREATE_KIT(RACE_CENTAUR, CLASS_RANGER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1108, -1}));

	CREATE_KIT(RACE_CENTAUR, CLASS_PALADIN, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1110, -1}));

	CREATE_KIT(RACE_CENTAUR, CLASS_ANTIPALADIN, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1110, -1}));

	CREATE_KIT(RACE_CENTAUR, CLASS_CLERIC, PROTECT({1119, 1120, 1121, 1122, 1124, 1126, 1127, -1}));

	CREATE_KIT(RACE_CENTAUR, CLASS_DRUID, PROTECT({1135, 1136, 1137, 1138, 1139, 1140, -1}));

	CREATE_KIT(RACE_CENTAUR, CLASS_SHAMAN, PROTECT({108, 109, 111, 1144, 1145, 1146, 1127, -1}));

	CREATE_KIT(RACE_CENTAUR, CLASS_SORCERER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_CENTAUR, CLASS_NECROMANCER, PROTECT({1112, 1114, 1115, 1141, 1142, 1143, 203, 204, -1}));

	CREATE_KIT(RACE_CENTAUR, CLASS_CONJURER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_CENTAUR, CLASS_SUMMONER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_CENTAUR, CLASS_MONK, PROTECT({1147, 1148, 1149, 1150, 1151, -1}));

	CREATE_KIT(RACE_CENTAUR, CLASS_MERCENARY, PROTECT({1101, 1102, 1103, 1104, 1106, 1107, 1108, 1112, -1}));

	CREATE_KIT(RACE_CENTAUR, CLASS_ROGUE, PROTECT({1112, 1112, 1128, 1129, 1130, 1131, 1132, 412, 412, 412, 412, 412, -1}));

	CREATE_KIT(RACE_CENTAUR, CLASS_BARD, PROTECT({1112, 1128, 1129, 1130, 1131, 1134, 1241, 203, 204, -1}));

	CREATE_KIT(RACE_CENTAUR, CLASS_ALCHEMIST, PROTECT({377, 676, 52, -1}));

	CREATE_KIT(RACE_CENTAUR, CLASS_ILLUSIONIST, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_CENTAUR, CLASS_ETHERMANCER, PROTECT({706, 735, 731, 731, -1}));

	CREATE_KIT(RACE_CENTAUR, CLASS_REAVER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1108, 203, 204, -1}));
	...
	CREATE_KIT(RACE_HARPY, CLASS_SHAMAN, PROTECT({731, 731, 706, 735, 107, 106, 105, 679, 388, -1}));

	/*Planetbound Illithid Basic*/
	CREATE_KIT(RACE_ILLITHID, 0, PROTECT({677, 283, 285, 1112, 286, 288, 290, 567, 609, 733, 1174, 1175, -1}));

	/*Planetbound Illithid Classes*/
	CREATE_KIT(RACE_PILLITHID, CLASS_WARRIOR, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1109, -1}));

	CREATE_KIT(RACE_PILLITHID, CLASS_PSIONICIST, PROTECT({1112, 706, 1131, -1}));

	CREATE_KIT(RACE_PILLITHID, CLASS_SORCERER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, -1}));

	CREATE_KIT(RACE_PILLITHID, CLASS_CONJURER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, -1}));

	CREATE_KIT(RACE_PILLITHID, CLASS_SUMMONER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, -1}));

	CREATE_KIT(RACE_PILLITHID, CLASS_ILLUSIONIST, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, -1}));
	...
	/*Githyanki Basic*/
	CREATE_KIT(RACE_GITHYANKI, 0, PROTECT({677, 283, 285, 1112, 286, 288, 290, 1180, 1181, -1}));

	CREATE_KIT(RACE_GITHYANKI, CLASS_CLERIC, PROTECT({1119, 1120, 1121, 1123, 1125, 1126, 1127, -1}));

	/*Githyanki Classes*/
	CREATE_KIT(RACE_GITHYANKI, CLASS_WARRIOR, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1109, -1}));

	CREATE_KIT(RACE_GITHYANKI, CLASS_RANGER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1108, -1}));

	CREATE_KIT(RACE_GITHYANKI, CLASS_PALADIN, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1110, -1}));

	CREATE_KIT(RACE_GITHYANKI, CLASS_ANTIPALADIN, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1110, -1}));

	CREATE_KIT(RACE_GITHYANKI, CLASS_DRUID, PROTECT({1135, 1136, 1137, 1138, 1139, 1140, -1}));

	CREATE_KIT(RACE_GITHYANKI, CLASS_SHAMAN, PROTECT({108, 109, 111, 1144, 1145, 1146, 1127, -1}));

	CREATE_KIT(RACE_GITHYANKI, CLASS_SORCERER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_GITHYANKI, CLASS_NECROMANCER, PROTECT({1112, 1114, 1115, 1141, 1142, 1143, 203, 204, -1}));

	CREATE_KIT(RACE_GITHYANKI, CLASS_CONJURER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_GITHYANKI, CLASS_SUMMONER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_GITHYANKI, CLASS_MONK, PROTECT({1147, 1148, 1149, 1150, 1151, -1}));

	CREATE_KIT(RACE_GITHYANKI, CLASS_MERCENARY, PROTECT({1101, 1102, 1103, 1104, 1106, 1107, 1108, 1112, -1}));

	CREATE_KIT(RACE_GITHYANKI, CLASS_ROGUE, PROTECT({1112, 1112, 1128, 1129, 1130, 1131, 1132, 412, 412, 412, 412, 412, -1}));

	CREATE_KIT(RACE_GITHYANKI, CLASS_BARD, PROTECT({1112, 1128, 1129, 1130, 1131, 1134, 1241, 203, 204, -1}));

	CREATE_KIT(RACE_GITHYANKI, CLASS_ALCHEMIST, PROTECT({377, 676, 52, -1}));

	CREATE_KIT(RACE_GITHYANKI, CLASS_ILLUSIONIST, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_GITHYANKI, CLASS_ETHERMANCER, PROTECT({706, 735, 731, 731, -1}));

	CREATE_KIT(RACE_GITHYANKI, CLASS_REAVER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1108, 203, 204, -1}));
	/*End Githyanki Classes*/

	/*Phantom Basic*/
	CREATE_KIT(RACE_PHANTOM, 0, PROTECT({677, 283, 285, 1112, 286, 288, 290, 1180, 1181, -1}));

	/*Phantom Classes*/
	CREATE_KIT(RACE_PHANTOM, CLASS_PSIONICIST, PROTECT({624, -1}));

	CREATE_KIT(RACE_PHANTOM, CLASS_REAVER, PROTECT({1109, 1108, 1107, 1106, 1105, 1105, 1104, 1103, 1102, 110, 604, 1157, 256, -1}));

	/* End Phantom Classes */

	/*Minotaur Classes*/
	CREATE_KIT(RACE_MINOTAUR, CLASS_WARRIOR, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1109, -1}));

	CREATE_KIT(RACE_MINOTAUR, CLASS_RANGER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1108, -1}));

	CREATE_KIT(RACE_MINOTAUR, CLASS_PALADIN, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1110, -1}));

	CREATE_KIT(RACE_MINOTAUR, CLASS_ANTIPALADIN, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1110, -1}));

	CREATE_KIT(RACE_MINOTAUR, CLASS_CLERIC, PROTECT({1119, 1120, 1121, 1122, 1124, 1126, 1127, -1}));

	CREATE_KIT(RACE_MINOTAUR, CLASS_DRUID, PROTECT({1135, 1136, 1137, 1138, 1139, 1140, -1}));

	CREATE_KIT(RACE_MINOTAUR, CLASS_SHAMAN, PROTECT({108, 109, 111, 1144, 1145, 1146, 1127, -1}));

	CREATE_KIT(RACE_MINOTAUR, CLASS_SORCERER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_MINOTAUR, CLASS_NECROMANCER, PROTECT({1112, 1114, 1115, 1141, 1142, 1143, 203, 204, -1}));

	CREATE_KIT(RACE_MINOTAUR, CLASS_CONJURER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_MINOTAUR, CLASS_SUMMONER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_MINOTAUR, CLASS_MONK, PROTECT({1147, 1148, 1149, 1150, 1151, -1}));

	CREATE_KIT(RACE_MINOTAUR, CLASS_MERCENARY, PROTECT({1101, 1102, 1103, 1104, 1106, 1107, 1108, 1112, -1}));

	CREATE_KIT(RACE_MINOTAUR, CLASS_ROGUE, PROTECT({1112, 1112, 1128, 1129, 1130, 1131, 1132, 412, 412, 412, 412, 412, -1}));

	CREATE_KIT(RACE_MINOTAUR, CLASS_BARD, PROTECT({1112, 1128, 1129, 1130, 1131, 1134, 1241, 203, 204, -1}));

	CREATE_KIT(RACE_MINOTAUR, CLASS_ALCHEMIST, PROTECT({377, 676, 52, -1}));

	CREATE_KIT(RACE_MINOTAUR, CLASS_ILLUSIONIST, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_MINOTAUR, CLASS_ETHERMANCER, PROTECT({706, 735, 731, 731, -1}));

	CREATE_KIT(RACE_MINOTAUR, CLASS_REAVER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1108, 203, 204, -1}));

	/*END Minotaur Classes*/

	/*Grey Elf Basics*/
	CREATE_KIT(RACE_GREY, 0, PROTECT({677, 283, 285, 1112, 286, 288, 290, 568, 610, 398, 398, 1158, 1159, -1}));

	/*Grey Elf Classes*/
	CREATE_KIT(RACE_GREY, CLASS_WARRIOR, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1109, -1}));

	CREATE_KIT(RACE_GREY, CLASS_RANGER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1108, -1}));

	CREATE_KIT(RACE_GREY, CLASS_PALADIN, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1110, -1}));

	CREATE_KIT(RACE_GREY, CLASS_ANTIPALADIN, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1110, -1}));

	CREATE_KIT(RACE_GREY, CLASS_CLERIC, PROTECT({1119, 1120, 1121, 1122, 1124, 1126, 1127, -1}));
	...
	CREATE_KIT(RACE_GREY, CLASS_SORCERER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_GREY, CLASS_NECROMANCER, PROTECT({1112, 1114, 1115, 1141, 1142, 1143, 203, 204, -1}));

	CREATE_KIT(RACE_GREY, CLASS_CONJURER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_GREY, CLASS_SUMMONER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_GREY, CLASS_MONK, PROTECT({1147, 1148, 1149, 1150, 1151, -1}));

	CREATE_KIT(RACE_GREY, CLASS_MERCENARY, PROTECT({1101, 1102, 1103, 1104, 1106, 1107, 1108, 1112, -1}));

	CREATE_KIT(RACE_GREY, CLASS_ROGUE, PROTECT({1112, 1112, 1128, 1129, 1130, 1131, 1132, 412, 412, 412, 412, 412, -1}));

	CREATE_KIT(RACE_GREY, CLASS_BARD, PROTECT({1112, 1128, 1129, 1130, 1131, 1134, 1241, 203, 204, -1}));

	CREATE_KIT(RACE_GREY, CLASS_ALCHEMIST, PROTECT({377, 676, 52, -1}));

	CREATE_KIT(RACE_GREY, CLASS_ILLUSIONIST, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_GREY, CLASS_ETHERMANCER, PROTECT({706, 735, 731, 731, -1}));

	CREATE_KIT(RACE_GREY, CLASS_REAVER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1108, 203, 204, -1}));

	/*END Grey Elf Classes*/

	/*Dwarf Basic*/
	CREATE_KIT(RACE_MOUNTAIN, 0, PROTECT({677, 283, 285, 1112, 286, 288, 290, 569, 611, 398, 398, 1162, 1163, -1}));

	/*Dwarf Classes*/
	CREATE_KIT(RACE_MOUNTAIN, CLASS_WARRIOR, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1109, -1}));

	CREATE_KIT(RACE_MOUNTAIN, CLASS_RANGER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1108, -1}));

	CREATE_KIT(RACE_MOUNTAIN, CLASS_PALADIN, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1110, -1}));

	CREATE_KIT(RACE_MOUNTAIN, CLASS_ANTIPALADIN, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1110, -1}));

	CREATE_KIT(RACE_MOUNTAIN, CLASS_CLERIC, PROTECT({1119, 1120, 1121, 1122, 1124, 1126, 1127, -1}));

	CREATE_KIT(RACE_MOUNTAIN, CLASS_DRUID, PROTECT({1135, 1136, 1137, 1138, 1139, 1140, -1}));

	CREATE_KIT(RACE_MOUNTAIN, CLASS_SHAMAN, PROTECT({108, 109, 111, 1144, 1145, 1146, 1127, -1}));

	CREATE_KIT(RACE_MOUNTAIN, CLASS_SORCERER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_MOUNTAIN, CLASS_NECROMANCER, PROTECT({1112, 1114, 1115, 1141, 1142, 1143, 203, 204, -1}));

	CREATE_KIT(RACE_MOUNTAIN, CLASS_CONJURER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_MOUNTAIN, CLASS_SUMMONER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_MOUNTAIN, CLASS_MONK, PROTECT({1147, 1148, 1149, 1150, 1151, -1}));

	CREATE_KIT(RACE_MOUNTAIN, CLASS_MERCENARY, PROTECT({1101, 1102, 1103, 1104, 1106, 1107, 1108, 1112, -1}));

	CREATE_KIT(RACE_MOUNTAIN, CLASS_ROGUE, PROTECT({1112, 1112, 1128, 1129, 1130, 1131, 1132, 412, 412, 412, 412, 412, -1}));

	CREATE_KIT(RACE_MOUNTAIN, CLASS_BARD, PROTECT({1112, 1128, 1129, 1130, 1131, 1134, 1241, 203, 204, -1}));

	CREATE_KIT(RACE_MOUNTAIN, CLASS_ALCHEMIST, PROTECT({377, 676, 52, -1}));

	CREATE_KIT(RACE_MOUNTAIN, CLASS_ILLUSIONIST, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_MOUNTAIN, CLASS_ETHERMANCER, PROTECT({706, 735, 731, 731, -1}));

	CREATE_KIT(RACE_MOUNTAIN, CLASS_REAVER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1108, 203, 204, -1}));

	/*END Dwarf Classes*/

	/*Ogre Basic*/
	CREATE_KIT(RACE_OGRE, 0, PROTECT({677, 283, 285, 1112, 286, 288, 290, 570, 612, 1170, 1183, 1183, 1184, -1}));

	/*Orog Basics*/
	CREATE_KIT(RACE_OROG, 0, PROTECT({677, 283, 285, 1112, 286, 288, 290, 1172, 1173, 612, -1}));

	/*Orog Classes*/
	CREATE_KIT(RACE_OGRE, CLASS_WARRIOR, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1109, -1}));

	CREATE_KIT(RACE_OGRE, CLASS_RANGER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1108, -1}));

	CREATE_KIT(RACE_OGRE, CLASS_PALADIN, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1110, -1}));

	CREATE_KIT(RACE_OGRE, CLASS_ANTIPALADIN, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1110, -1}));

	CREATE_KIT(RACE_OGRE, CLASS_CLERIC, PROTECT({1119, 1120, 1121, 1122, 1124, 1126, 1127, -1}));
	...
	CREATE_KIT(RACE_OGRE, CLASS_SORCERER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_OGRE, CLASS_NECROMANCER, PROTECT({1112, 1114, 1115, 1141, 1142, 1143, 203, 204, -1}));

	CREATE_KIT(RACE_OGRE, CLASS_CONJURER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_OGRE, CLASS_SUMMONER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_OGRE, CLASS_MONK, PROTECT({1147, 1148, 1149, 1150, 1151, -1}));

	CREATE_KIT(RACE_OGRE, CLASS_MERCENARY, PROTECT({1101, 1102, 1103, 1104, 1106, 1107, 1108, 1112, -1}));

	CREATE_KIT(RACE_OGRE, CLASS_ROGUE, PROTECT({1112, 1112, 1128, 1129, 1130, 1131, 1132, 412, 412, 412, 412, 412, -1}));

	CREATE_KIT(RACE_OGRE, CLASS_BARD, PROTECT({1112, 1128, 1129, 1130, 1131, 1134, 1241, 203, 204, -1}));

	CREATE_KIT(RACE_OGRE, CLASS_ALCHEMIST, PROTECT({377, 676, 52, -1}));

	CREATE_KIT(RACE_OGRE, CLASS_ILLUSIONIST, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_OGRE, CLASS_ETHERMANCER, PROTECT({706, 735, 731, 731, -1}));

	CREATE_KIT(RACE_OGRE, CLASS_REAVER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1108, 203, 204, -1}));

	/*Orc Classes*/
	CREATE_KIT(RACE_ORC, CLASS_WARRIOR, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1109, -1}));

	CREATE_KIT(RACE_ORC, CLASS_RANGER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1108, -1}));

	CREATE_KIT(RACE_ORC, CLASS_PALADIN, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1110, -1}));

	CREATE_KIT(RACE_ORC, CLASS_ANTIPALADIN, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1110, -1}));

	CREATE_KIT(RACE_ORC, CLASS_CLERIC, PROTECT({1119, 1120, 1121, 1122, 1124, 1126, 1127, -1}));
	...
	CREATE_KIT(RACE_ORC, CLASS_SORCERER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_ORC, CLASS_NECROMANCER, PROTECT({1112, 1114, 1115, 1141, 1142, 1143, 203, 204, -1}));

	CREATE_KIT(RACE_ORC, CLASS_CONJURER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_ORC, CLASS_SUMMONER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_ORC, CLASS_MONK, PROTECT({1147, 1148, 1149, 1150, 1151, -1}));

	CREATE_KIT(RACE_ORC, CLASS_MERCENARY, PROTECT({1101, 1102, 1103, 1104, 1106, 1107, 1108, 1112, -1}));

	CREATE_KIT(RACE_ORC, CLASS_ROGUE, PROTECT({1112, 1112, 1128, 1129, 1130, 1131, 1132, 412, 412, 412, 412, 412, -1}));

	CREATE_KIT(RACE_ORC, CLASS_BARD, PROTECT({1112, 1128, 1129, 1130, 1131, 1134, 1241, 203, 204, -1}));

	CREATE_KIT(RACE_ORC, CLASS_ALCHEMIST, PROTECT({377, 676, 52, -1}));

	CREATE_KIT(RACE_ORC, CLASS_ILLUSIONIST, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_ORC, CLASS_ETHERMANCER, PROTECT({706, 735, 731, 731, -1}));

	CREATE_KIT(RACE_ORC, CLASS_REAVER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1108, 203, 204, -1}));

	CREATE_KIT(RACE_ORC, CLASS_BERSERKER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1109, -1}));

	/*END Orc Classes*/

	/*Lich Basics*/
	CREATE_KIT(RACE_LICH, 0, PROTECT({677, 283, 285, 1112, 286, 288, 290, 1172, 1173, 612, -1}));

	/*Lich Classes */
	CREATE_KIT(RACE_LICH, CLASS_ALCHEMIST, PROTECT({377, 676, 52, -1}));

	CREATE_KIT(RACE_LICH, CLASS_DREADLORD, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 286, -1}));

	CREATE_KIT(RACE_LICH, CLASS_NECROMANCER, PROTECT({1112, 1114, 1115, 1141, 1142, 1143, -1}));

	/*END Lich Classes */

	/*Death Knight Basics*/
	CREATE_KIT(RACE_PDKNIGHT, 0, PROTECT({677, 283, 285, 1112, 286, 288, 290, 1106, 1107, -1}));

	/*Death Knight Classes */
	CREATE_KIT(RACE_PDKNIGHT, CLASS_WARRIOR, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1108, 1109, -1}));
	...
	CREATE_KIT(RACE_VAMPIRE, 0, PROTECT({677, 283, 285, 1112, 286, 288, 290, 1172, 1173, 612, -1}));

	/*Vampire Classes */

	CREATE_KIT(RACE_VAMPIRE, CLASS_ANTIPALADIN, PROTECT({1101, 1102, 1103, 1107, 1111, -1}));

	CREATE_KIT(RACE_VAMPIRE, CLASS_THIEF, PROTECT({1112, 1128, 1129, 1130, 1131, 1132, 412, 412, 412, 412, 412, -1}));

	CREATE_KIT(RACE_VAMPIRE, CLASS_ASSASSIN, PROTECT({1112, 1112, 1128, 1129, 1130, 1131, -1}));

	CREATE_KIT(RACE_VAMPIRE, CLASS_WARRIOR, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1109, -1}));

	CREATE_KIT(RACE_VAMPIRE, CLASS_MERCENARY, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1112, -1}));

	CREATE_KIT(RACE_VAMPIRE, CLASS_DREADLORD, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 286, -1}));
	/*END Vampire Classes */

	/*Wight Basics*/
	CREATE_KIT(RACE_WIGHT, 0, PROTECT({677, 283, 285, 1112, 286, 288, 290, 1172, 1173, 612, -1}));
	/*Wight Classes*/
	CREATE_KIT(RACE_WIGHT, CLASS_WARRIOR, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1109, 286, -1}));
	CREATE_KIT(RACE_WIGHT, CLASS_MERCENARY, PROTECT({1101, 1102, 1103, 1104, 1106, 1107, 1108, 1112, 286, -1}));
	/*END Wight Classes*/

	/*Storm Giant Basics*/
	CREATE_KIT(RACE_SGIANT, 0, PROTECT({677, 283, 285, 1112, 286, 288, 290, 1172, 1173, 612, -1}));
	/*Storm Giant Classes*/
	CREATE_KIT(RACE_SGIANT, CLASS_WARRIOR, PROTECT({1103, 1104, 1105, 1105, 1106, 1107, 1108, 1109, 286, 274, -1}));
	CREATE_KIT(RACE_SGIANT, CLASS_MERCENARY, PROTECT({1103, 1104, 1106, 1107, 1108, 1112, 286, 274, -1}));
	/*END Storm Giant Classes*/

	/*Shade Basics*/
	CREATE_KIT(RACE_SHADE, 0, PROTECT({677, 283, 285, 1112, 286, 288, 290, 1172, 1173, 612, -1}));
	/*Shade Classes*/
	CREATE_KIT(RACE_SHADE, CLASS_WARRIOR, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1109, -1}));
	CREATE_KIT(RACE_SHADE, CLASS_MERCENARY, PROTECT({1101, 1102, 1103, 1104, 1106, 1107, 1108, 1112, -1}));
	CREATE_KIT(RACE_SHADE, CLASS_REAVER, PROTECT({1109, 1108, 1107, 1106, 1105, 1105, 1104, 1103, 1102, 110, 604, 1157, 256, -1}));
	CREATE_KIT(RACE_SHADE, CLASS_DREADLORD, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 286, -1}));

	/*END Shade Classes*/

	/*Revenant Basics*/
	CREATE_KIT(RACE_REVENANT, 0, PROTECT({677, 283, 285, 1112, 286, 288, 290, 1172, 1173, 612, -1}));
	/*Revenant Classes*/
	CREATE_KIT(RACE_REVENANT, CLASS_WARRIOR, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1109, -1}));
	CREATE_KIT(RACE_REVENANT, CLASS_MERCENARY, PROTECT({1101, 1102, 1103, 1104, 1106, 1107, 1108, 1112, -1}));
	/*END Revenant Classes*/

	/*Shadow beast Basics*/

	CREATE_KIT(RACE_PSBEAST, 0, PROTECT({677, 283, 285, 1112, 286, 288, 290, 1172, 1173, 612, -1}));

	/*Shadow Beast Classes */

	CREATE_KIT(RACE_PSBEAST, CLASS_ASSASSIN, PROTECT({1112, 1112, 1128, 1129, 1130, 1131, -1}));

	CREATE_KIT(RACE_PSBEAST, CLASS_THIEF, PROTECT({1112, 1128, 1129, 1130, 1131, 1132, 412, 412, 412, 412, 412, -1}));

	CREATE_KIT(RACE_PSBEAST, CLASS_WARRIOR, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1109, -1}));

	CREATE_KIT(RACE_PSBEAST, CLASS_MERCENARY, PROTECT({1101, 1102, 1103, 1104, 1106, 1107, 1108, 1112, -1}));
	/* End shadow beast */

	/*Troll Basic*/
	CREATE_KIT(RACE_TROLL, 0, PROTECT({677, 283, 285, 1112, 286, 288, 290, 1172, 1155, 571, 613, -1}));

	/*Troll Classes*/
	CREATE_KIT(RACE_TROLL, CLASS_WARRIOR, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1109, -1}));

	CREATE_KIT(RACE_TROLL, CLASS_RANGER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1108, -1}));

	CREATE_KIT(RACE_TROLL, CLASS_PALADIN, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1110, -1}));

	CREATE_KIT(RACE_TROLL, CLASS_ANTIPALADIN, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1110, -1}));

	CREATE_KIT(RACE_TROLL, CLASS_CLERIC, PROTECT({1119, 1120, 1121, 1122, 1124, 1126, 1127, -1}));

	CREATE_KIT(RACE_TROLL, CLASS_DRUID, PROTECT({1135, 1136, 1137, 1138, 1139, 1140, -1}));

	CREATE_KIT(RACE_TROLL, CLASS_SHAMAN, PROTECT({108, 109, 111, 1144, 1145, 1146, 1127, -1}));

	CREATE_KIT(RACE_TROLL, CLASS_SORCERER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_TROLL, CLASS_NECROMANCER, PROTECT({1112, 1114, 1115, 1141, 1142, 1143, 203, 204, -1}));

	CREATE_KIT(RACE_TROLL, CLASS_CONJURER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_TROLL, CLASS_SUMMONER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_TROLL, CLASS_MONK, PROTECT({1147, 1148, 1149, 1150, 1151, -1}));

	CREATE_KIT(RACE_TROLL, CLASS_MERCENARY, PROTECT({1101, 1102, 1103, 1104, 1106, 1107, 1108, 1112, -1}));

	CREATE_KIT(RACE_TROLL, CLASS_ROGUE, PROTECT({1112, 1112, 1128, 1129, 1130, 1131, 1132, 412, 412, 412, 412, 412, -1}));

	CREATE_KIT(RACE_TROLL, CLASS_BARD, PROTECT({1112, 1128, 1129, 1130, 1131, 1134, 1241, 203, 204, -1}));

	CREATE_KIT(RACE_TROLL, CLASS_ALCHEMIST, PROTECT({377, 676, 52, -1}));

	CREATE_KIT(RACE_TROLL, CLASS_ILLUSIONIST, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_TROLL, CLASS_ETHERMANCER, PROTECT({706, 735, 731, 731, -1}));

	CREATE_KIT(RACE_TROLL, CLASS_REAVER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1108, 203, 204, -1}));

	/*END Troll Classes*/

	/*Goblin Basics*/
	CREATE_KIT(RACE_GOBLIN, 0, PROTECT({677, 283, 285, 1112, 286, 288, 290, 1172, 1173, 612, -1}));

	/*Goblin Classes*/
	CREATE_KIT(RACE_GOBLIN, CLASS_WARRIOR, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1109, -1}));

	CREATE_KIT(RACE_GOBLIN, CLASS_RANGER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1108, -1}));

	CREATE_KIT(RACE_GOBLIN, CLASS_PALADIN, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1110, -1}));

	CREATE_KIT(RACE_GOBLIN, CLASS_ANTIPALADIN, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1110, -1}));

	CREATE_KIT(RACE_GOBLIN, CLASS_CLERIC, PROTECT({1119, 1120, 1121, 1122, 1124, 1126, 1127, -1}));

	CREATE_KIT(RACE_GOBLIN, CLASS_DRUID, PROTECT({1135, 1136, 1137, 1138, 1139, 1140, -1}));

	CREATE_KIT(RACE_GOBLIN, CLASS_SHAMAN, PROTECT({108, 109, 111, 1144, 1145, 1146, 1127, -1}));

	CREATE_KIT(RACE_GOBLIN, CLASS_SORCERER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_GOBLIN, CLASS_NECROMANCER, PROTECT({1112, 1114, 1115, 1141, 1142, 1143, 203, 204, -1}));

	CREATE_KIT(RACE_GOBLIN, CLASS_CONJURER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_GOBLIN, CLASS_SUMMONER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_GOBLIN, CLASS_MONK, PROTECT({1147, 1148, 1149, 1150, 1151, -1}));

	CREATE_KIT(RACE_GOBLIN, CLASS_MERCENARY, PROTECT({1101, 1102, 1103, 1104, 1106, 1107, 1108, 1112, -1}));

	CREATE_KIT(RACE_GOBLIN, CLASS_ROGUE, PROTECT({1112, 1112, 1128, 1129, 1130, 1131, 1132, 412, 412, 412, 412, 412, -1}));

	CREATE_KIT(RACE_GOBLIN, CLASS_BARD, PROTECT({1112, 1128, 1129, 1130, 1131, 1134, 1241, 203, 204, -1}));

	CREATE_KIT(RACE_GOBLIN, CLASS_ALCHEMIST, PROTECT({377, 676, 52, -1}));

	CREATE_KIT(RACE_GOBLIN, CLASS_ILLUSIONIST, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_GOBLIN, CLASS_ETHERMANCER, PROTECT({706, 735, 731, 731, -1}));

	CREATE_KIT(RACE_GOBLIN, CLASS_REAVER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1108, 203, 204, -1}));

	/*END Goblin Classes*/

	/*Drider Basics*/
	CREATE_KIT(RACE_DRIDER, 0, PROTECT({677, 283, 285, 1112, 286, 288, 290, 561, 604, 36016, 1156, 1157, -1}));

	/*Drider Classes*/
	CREATE_KIT(RACE_DRIDER, CLASS_WARRIOR, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1109, -1}));

	CREATE_KIT(RACE_DRIDER, CLASS_CLERIC, PROTECT({1119, 1120, 1121, 1123, 1125, 1126, 1127, -1}));

	CREATE_KIT(RACE_DRIDER, CLASS_SORCERER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, -1}));

	CREATE_KIT(RACE_DRIDER, CLASS_CONJURER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, -1}));

	CREATE_KIT(RACE_DRIDER, CLASS_SUMMONER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, -1}));

	CREATE_KIT(RACE_DRIDER, CLASS_NECROMANCER, PROTECT({1112, 1114, 1115, 1141, 1142, 1143, -1}));

	CREATE_KIT(RACE_DRIDER, CLASS_REAVER, PROTECT({1109, 1108, 1107, 1106, 1105, 1104, 1103, 1102, 1101, 604, 1157, 1156, 1115, 1114, -1}));

	/* END Drider Classes */

	/*Kobold Basics*/
	CREATE_KIT(RACE_KOBOLD, 0, PROTECT({677, 283, 285, 1112, 286, 288, 290, 1172, 1173, 612, -1}));

	/*Goblin Classes*/
	CREATE_KIT(RACE_KOBOLD, CLASS_WARRIOR, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1109, -1}));

	CREATE_KIT(RACE_KOBOLD, CLASS_RANGER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1108, -1}));

	CREATE_KIT(RACE_KOBOLD, CLASS_PALADIN, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1110, -1}));

	CREATE_KIT(RACE_KOBOLD, CLASS_ANTIPALADIN, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1110, -1}));

	CREATE_KIT(RACE_KOBOLD, CLASS_CLERIC, PROTECT({1119, 1120, 1121, 1122, 1124, 1126, 1127, -1}));

	CREATE_KIT(RACE_KOBOLD, CLASS_DRUID, PROTECT({1135, 1136, 1137, 1138, 1139, 1140, -1}));

	CREATE_KIT(RACE_KOBOLD, CLASS_SHAMAN, PROTECT({108, 109, 111, 1144, 1145, 1146, 1127, -1}));

	CREATE_KIT(RACE_KOBOLD, CLASS_SORCERER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_KOBOLD, CLASS_NECROMANCER, PROTECT({1112, 1114, 1115, 1141, 1142, 1143, 203, 204, -1}));

	CREATE_KIT(RACE_KOBOLD, CLASS_CONJURER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_KOBOLD, CLASS_SUMMONER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_KOBOLD, CLASS_MONK, PROTECT({1147, 1148, 1149, 1150, 1151, -1}));

	CREATE_KIT(RACE_KOBOLD, CLASS_MERCENARY, PROTECT({1101, 1102, 1103, 1104, 1106, 1107, 1108, 1112, -1}));

	CREATE_KIT(RACE_KOBOLD, CLASS_ROGUE, PROTECT({1112, 1112, 1128, 1129, 1130, 1131, 1132, 412, 412, 412, 412, 412, -1}));

	CREATE_KIT(RACE_KOBOLD, CLASS_BARD, PROTECT({1112, 1128, 1129, 1130, 1131, 1134, 1241, 203, 204, -1}));

	CREATE_KIT(RACE_KOBOLD, CLASS_ALCHEMIST, PROTECT({377, 676, 52, -1}));

	CREATE_KIT(RACE_KOBOLD, CLASS_ILLUSIONIST, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_KOBOLD, CLASS_ETHERMANCER, PROTECT({706, 735, 731, 731, -1}));

	CREATE_KIT(RACE_KOBOLD, CLASS_REAVER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1108, 203, 204, -1}));

	/*END Kobold Classes*/

	/*Kuo Toa Basic*/
	CREATE_KIT(RACE_KUOTOA, 0, PROTECT({677, 283, 285, 1112, 286, 288, 290, 1172, 1155, 571, 613, -1}));

	/*Troll Classes*/
	CREATE_KIT(RACE_KUOTOA, CLASS_CLERIC, PROTECT({706, 735, 731, 731, -1}));

	CREATE_KIT(RACE_KUOTOA, CLASS_MERCENARY, PROTECT({1101, 1102, 1103, 1104, 1106, 1107, 1108, 1112, -1}));

	CREATE_KIT(RACE_KUOTOA, CLASS_SHAMAN, PROTECT({108, 109, 111, 1144, 1145, 1146, 1127, -1}));

	CREATE_KIT(RACE_KUOTOA, CLASS_WARRIOR, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1109, -1}));

	CREATE_KIT(RACE_KUOTOA, CLASS_ROGUE, PROTECT({1112, 1128, 1129, 1130, 1131, 412, 412, 412, -1}));

	/*END Troll Classes*/

	/* Firbolg Basic */
	CREATE_KIT(RACE_FIRBOLG, 0, PROTECT({677, 283, 285, 1112, 286, 288, 290, 560, 603, 398, 398, 1154, 1155, -1}));

	/* Firbolg Classes */
	CREATE_KIT(RACE_FIRBOLG, CLASS_WARRIOR, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1109, -1}));

	CREATE_KIT(RACE_FIRBOLG, CLASS_RANGER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1108, -1}));

	CREATE_KIT(RACE_FIRBOLG, CLASS_PALADIN, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1110, -1}));

	CREATE_KIT(RACE_FIRBOLG, CLASS_ANTIPALADIN, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1110, -1}));

	CREATE_KIT(RACE_FIRBOLG, CLASS_CLERIC, PROTECT({1119, 1120, 1121, 1122, 1124, 1126, 1127, -1}));

	CREATE_KIT(RACE_FIRBOLG, CLASS_DRUID, PROTECT({1135, 1136, 1137, 1138, 1139, 1140, -1}));

	CREATE_KIT(RACE_FIRBOLG, CLASS_SHAMAN, PROTECT({108, 109, 111, 1144, 1145, 1146, 1127, -1}));

	CREATE_KIT(RACE_FIRBOLG, CLASS_SORCERER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_FIRBOLG, CLASS_NECROMANCER, PROTECT({1112, 1114, 1115, 1141, 1142, 1143, 203, 204, -1}));

	CREATE_KIT(RACE_FIRBOLG, CLASS_CONJURER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_FIRBOLG, CLASS_SUMMONER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_FIRBOLG, CLASS_MONK, PROTECT({1147, 1148, 1149, 1150, 1151, -1}));

	CREATE_KIT(RACE_FIRBOLG, CLASS_MERCENARY, PROTECT({1101, 1102, 1103, 1104, 1106, 1107, 1108, 1112, -1}));

	CREATE_KIT(RACE_FIRBOLG, CLASS_ROGUE, PROTECT({1112, 1112, 1128, 1129, 1130, 1131, 1132, 412, 412, 412, 412, 412, -1}));

	CREATE_KIT(RACE_FIRBOLG, CLASS_BARD, PROTECT({1112, 1128, 1129, 1130, 1131, 1134, 1241, 203, 204, -1}));

	CREATE_KIT(RACE_FIRBOLG, CLASS_ALCHEMIST, PROTECT({377, 676, 52, -1}));

	CREATE_KIT(RACE_FIRBOLG, CLASS_ILLUSIONIST, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, 203, 204, -1}));

	CREATE_KIT(RACE_FIRBOLG, CLASS_ETHERMANCER, PROTECT({706, 735, 731, 731, -1}));

	CREATE_KIT(RACE_FIRBOLG, CLASS_REAVER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1108, 203, 204, -1}));
	/* END Firbolg */

	/*Wood Elf Basics*/
	CREATE_KIT(RACE_WOODELF, 0, PROTECT({677, 283, 285, 1112, 286, 288, 290, 568, 610, 398, 398, 1158, 1159, -1}));

	/*Wood Elf Classes*/
	CREATE_KIT(RACE_WOODELF, CLASS_WARRIOR, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1108, 1109, -1}));

	CREATE_KIT(
		RACE_WOODELF, CLASS_RANGER, PROTECT({1101, 1102, 1103, 1104, 1105, 1105, 1106, 1107, 1113, 1113, 1114, 1115, 1116, 1117, 1117, 1117, 1117, 1117, 1117, 1117, 1117, 1117, 1117, 1118, -1}));

	CREATE_KIT(RACE_WOODELF, CLASS_CLERIC, PROTECT({1119, 1120, 1121, 1122, 1124, 1126, 1127, -1}));

	CREATE_KIT(RACE_WOODELF, CLASS_CONJURER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, -1}));

	CREATE_KIT(RACE_WOODELF, CLASS_SUMMONER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, -1}));

	CREATE_KIT(RACE_WOODELF, CLASS_DRUID, PROTECT({1135, 1136, 1137, 1138, 1139, 1140, -1}));

	CREATE_KIT(RACE_WOODELF, CLASS_SORCERER, PROTECT({1114, 1115, 1131, 706, 735, 731, 731, -1}));

	CREATE_KIT(RACE_WOODELF, CLASS_THIEF, PROTECT({1112, 1128, 1129, 1130, 1131, 1132, 412, 412, 412, 412, 412, -1}));

	CREATE_KIT(RACE_WOODELF, CLASS_ROGUE, PROTECT({1112, 1128, 1129, 1130, 1131, 1132, 412, 412, 412, 412, 412, -1}));
...
{
	int         i;
	const char *smart_ass[] = {"someone",   "somebody",  "me",        "self",      "all",  "group", "local", "them", "they",  "nobody", "any",    "something",
	                           "other",     "no",        "yes",       "north",     "east", "south", "west",  "up",   "down",  "shape", /* infra.. */
	                           "shadow",                                                                                               /* summon */
	                           "northeast", "southeast", "northwest", "southwest", "nw",   "ne",    "sw",    "se",   "guide", "he",     "she",    "it",
	                           "him",       "his",       "her",       "boy",       "girl", "man",   "woman", "it",   "mail",  "male",   "female",
...
void schedule_pc_events(P_char ch)
{
	...
	if (!IS_ALIVE(ch))
	{
		debug("schedule_pc_events: DEAD/NONEXISTANT char %s '%s'.", (ch == NULL) ? "!" : IS_NPC(ch) ? "NPC" : "PC", (ch == NULL) ? "NULL" : J_NAME(ch));
		logit(LOG_DEBUG, "schedule_pc_events: DEAD/NONEXISTANT char %s '%s'.", (ch == NULL) ? "!" : IS_NPC(ch) ? "NPC" : "PC", (ch == NULL) ? "NULL" : J_NAME(ch));
		return;
	}
...
void enter_game(P_desc d)
{
	...
	for (afp1 = ch->affected; afp1; afp1 = afp2)
	{
		...
		if (IS_SET(afp1->flags, AFFTYPE_OFFLINE))
		{
			...
			if (IS_SET(afp1->flags, AFFTYPE_SHORT))
			{
				...
				{
					if (evp->func == event_short_affect && evp->data != NULL && ((struct event_short_affect_data *)(evp->data))->af == afp1)
					{
	...
	if (IS_NEWBIE(ch))
	{
		...
		for (i = descriptor_list; i; i = i->next)
		{
			...
			if (!IS_SET(PLR2_FLAGS(i->character), PLR2_NEWBIE_GUIDE))
				continue;
			if (IS_DISGUISE_PC(i->character) || IS_DISGUISE_ILLUSION(i->character) || IS_DISGUISE_SHAPE(i->character))
				continue;
	...
	*(timestr + strlen(timestr) - 1) = '\0';
	...
	loginlog(GET_LEVEL(ch), "%s [%s] enters game @ %s.%s [%d]", GET_NAME(ch), d->host, timestr, Gbuf1, world[ch->in_room].number);
	sql_log(ch, CONNECTLOG, "Entered Game");

	if (GET_LEVEL(ch) >= MINLVLIMMORTAL)
		loginlog(GET_LEVEL(ch), "&+GIMMORTAL&n: (%s) [%s] has logged on.%s", GET_NAME(ch), d->host, Gbuf1);
...
void select_terminal(P_desc d, char *arg)
{
	...
	switch (term)
	{
		...
		case TERM_HELP:
			...
			SEND_TO_Q("Please enter term type (<CR> for ANSI, '1' for Generic, '9' for Quick): ", d);
			return;
		default:
			SEND_TO_Q("Unknown terminal type!\r\n", d);
			SEND_TO_Q("Please re-enter term type (<CR> for ANSI, '1' for Generic, '9' for Quick): ", d);
			return;
	}
...
int is_invited(char *name) { return (pfile_exists("Players/Invited", name)); }
...
void approve_name(char *name) { create_denied_file("Players/Accepted", name); }

void deny_name(char *name) { create_denied_file(BADNAME_DIR, name); }
...
void select_name(P_desc d, char *arg, int flag)
{
	...
	*tmp_name = toupper(*tmp_name);
	...
	/* new player */
	if ((IS_SET(game_locked, LOCK_CREATION) || !strcmp(get_mud_info("lock").c_str(), "create")) && !pfile_exists("Players/Accepted", tmp_name))
	{
		if (!flag && d->character)
		{
			free_char(d->character);
...
P_char find_ch_from_same_host(P_desc d)
{
	...
	{
		if (!tmp_ch->desc && IS_PC(tmp_ch) && str_cmp(GET_NAME(tmp_ch), GET_NAME(d->character)) && !IS_TRUSTED(tmp_ch) && tmp_ch->only.pc->last_ip == ip2ul(d->host))
		{
			return tmp_ch;
		}
	}
...
bool violating_one_hour_rule(P_desc d)
{
	...
	send_to_char_f(d->character,
	               ...
	               racewar_color[racewar_side].color,
	               racewar_color[racewar_side].name,
	               timer / 60,
	               timer % 60);
	return TRUE;
}
	...
	switch (STATE(d))
	{
		...
		case CON_PWD_NORM:
			...
			else
			{
				...
				{
					if (!tmp_ch->desc && IS_PC(tmp_ch) && !str_cmp(GET_NAME(d->character), GET_NAME(tmp_ch)))
					{
						reconnect(d, tmp_ch);
						return;
					}
				...
				if ((IS_SET(game_locked, LOCK_MAX_PLAYERS)) && !IS_TRUSTED(d->character) && (number_of_players() > game_locked_players))
				{
					snprintf(Gbuf1, MAX_STRING_LENGTH, "Game is temporarily locked to %d chars.\n", game_locked_players);
					SEND_TO_Q(Gbuf1, d);
				...
				if (IS_TRUSTED(d->character))
				{
					...
					{
						wizlog(AVATAR, "WARNING: %s connected from an invalid site: %s", GET_NAME(d->character), d->host);
...
void select_sex(P_desc d, char *arg)
{
	...
	switch (*arg)
	{
		...
		default:
			SEND_TO_Q("That's not a valid option...\r\n", d);
			SEND_TO_Q("Please select either F (for Female), M (for Male), or Z (for Race Selection): ", d);
			return;
	}
...
void select_race(P_desc d, char *arg)
{
	...
	else if ((GET_RACE(d->character) != RACE_ILLITHID) && (GET_RACE(d->character) != RACE_PILLITHID))
	{
...
void select_hometown(P_desc d, char *arg)
{
	...
	for (int i = 0; i <= LAST_HOME; i++)
	{
		...
		if ((avail_hometowns[i][GET_RACE(d->character)] == 1) && (LOWER(*arg) == LOWER(town_name_list[i][0])))
		{
			home = i;
			break;
		}
...
void show_avail_hometowns(P_desc d)
{
	...
	for (i = 0; i <= LAST_HOME; i++)
	{
		if (avail_hometowns[i][race] == 1)
		{
			...
			// else
			// {
			snprintf(Gbuf1, MAX_STRING_LENGTH, "%c)%s\r\n", town_name_list[i][0], &town_name_list[i][1]);
			SEND_TO_Q(Gbuf1, d);
			// }
		}
	}
...
void find_starting_location(P_char ch, int hometown)
{
	...
	{
		snprintf(Gbuf1, MAX_STRING_LENGTH, "find_starting_location: illegal hometown %d for %s", hometown, GET_NAME(ch));
	...
	{
		snprintf(Gbuf1, MAX_STRING_LENGTH, "find_starting_location: illegal class %d for %s", ch->player.m_class, GET_NAME(ch));
		logit(LOG_DEBUG, Gbuf1);
		GET_HOME(ch) = guild_locations[HOME_THARN][0]; /* default */
		return;
	}
	...
	if (guild_num == -1)
	{
		snprintf(Gbuf1, MAX_STRING_LENGTH, "find_starting_location: hometown %d, no guild for class %d (%s)", hometown, ch->player.m_class, GET_NAME(ch));
		logit(LOG_DEBUG, Gbuf1);
	...
	switch (STATE(d))
	{
		...
		case CON_NAME_CONF:
			...
			else
			{
				if (*arg == 'n' || *arg == 'N')
				{
					SEND_TO_Q("\r\nOk, what IS it, then? Type 'generate' for name generator.", d);
					FREE(d->character->player.name);
 ...
 */
			...
			else
			{
				if (*arg == 'n' || *arg == 'N')
				{
					SEND_TO_Q("Resetting...\r\n\r\nBy what name do you wish to be known? Type 'generate' to get to name generator.", d);
					FREE(d->character->player.name);
					d->character->player.name = 0;
					STATE(d)                  = CON_NAME;
				}
		...
		case CON_KEEPCHAR:
			...
			if (STATE(d) == CON_RMOTD)
			{
				...
				statuslog(d->character->player.level, "%s [%s] new player.", GET_NAME(d->character), d->host);
		...
		case CON_GET_RETURN:
			...
			SEND_TO_Q("\r\n\r\n*** Do you agree to abide by everything written in the set of rules?", d);
		...
		case CON_DISCLMR:
			...
			{
				SEND_TO_Q("This name has been accepted before, and it is accepted once more.\r\n\r\n"
				          "*** PRESS RETURN:\r\n",
				          d);
				STATE(d) = CON_RMOTD;
				statuslog(d->character->player.level, "%s auto-accepted due to having been accepted before.", GET_NAME(d->character));
			}
