...
void   do_dragon_roar(P_char, char *, int);
void   do_dragon_breath(P_char, char *, int);
void   do_dragon_strike(P_char, char *, int);
...
bool   spell_general_portal(int level, P_char ch, P_char victim, struct portal_settings *settings, struct portal_create_messages *messages, bool isOneWay = false);
...
void spell_igneus_vitae(int, P_char, char *, int, P_char, P_obj);
void spell_sanguinis_ignis(int, P_char, char *, int, P_char, P_obj);
void spell_sanctum_draconis(int, P_char, char *, int, P_char, P_obj);
void spell_vivernae_concordia(int, P_char, char *, int, P_char, P_obj);
void spell_pactum_serpentis(int, P_char, char *, int, P_char, P_obj);
void spell_ritus_draconum(int, P_char, char *, int, P_char, P_obj);
